document.addEventListener('DOMContentLoaded', function() {
        ...
        // Event Listener für das Overlay (Schließen beim Klick)
        overlay.addEventListener('click', function() {
            sideNav.classList.remove('active');
            overlay.classList.remove('active');
        });
    
        // Optional: Event Listener für die untere Navigation, wenn benötigt
        const bottomNavItems = document.querySelectorAll('.bottom-nav li');
    
        bottomNavItems.forEach(function(item) {
            item.addEventListener('click', function() {
                // Entferne 'active' Klasse von allen Navigationselementen
                bottomNavItems.forEach(function(nav) {
                    nav.classList.remove('active');
                });
                // Füge 'active' Klasse dem geklickten Element hinzu
                this.classList.add('active');
    
                // Hier können Sie den entsprechenden Tab-Inhalt anzeigen
